...
export default function HomePage() {
  ...
  return (
    <main>
      {/* Hero Section */}
      {loading ? (
        <div className="h-[80vh] w-full flex items-center justify-center text-white bg-black/50">Cargando catálogo premium...</div>
      ) : contents.length === 0 ? (
        <div className="h-[80vh] w-full flex items-center justify-center text-center text-white bg-black/50">
          <div>
        ...
        <>
          ...
          <div className="relative z-10 -mt-24 pb-20 space-y-12">
            ...
            <div className="px-12 md:px-16 mb-8">
