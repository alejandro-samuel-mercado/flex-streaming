...
import { LayoutDashboard, LogOut, MonitorPlay, Users } from 'lucide-react';
import Link from 'next/link';
import { usePathname, useRouter } from 'next/navigation';
import { useCallback, useEffect, useState } from 'react';

const NAV = [
  { href: '/vendor', label: 'Inicio', icon: LayoutDashboard, exact: true },
  { href: '/vendor/end-users', label: 'Clientes', icon: Users, exact: false },
  { href: '/', label: 'Ver Nuba', icon: MonitorPlay, exact: true },
];
      ...
      <div className="vendor-main-wrapper">
        <header className="vendor-header">
          <div className="vendor-brand">
            Nuba <span className="vendor-brand-accent">Vendor</span>
          </div>
